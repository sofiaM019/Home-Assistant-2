...
async def test_async_get_floor_by_alias(
    floor_registry: fr.FloorRegistry,
) -> None:
    """Make sure we can get the floors by alias."""
    floor = floor_registry.async_create("First floor", aliases=("alias_1", "alias_2"))
    floor2 = floor_registry.async_get_floor_by_alias("alias_1")
    floor3 = floor_registry.async_get_floor_by_alias("a l i a s _ 2")
